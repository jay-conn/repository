 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Brittney Hendershot");
		  toPrint += p1.toString("900226965");
		  //Person2 replace P2 with your name
		  //and csuLaker with your laker id
		  Person2 p2 = new Person2("david");
		  toPrint += p2.toString("900449732");
		  //Person3 replace P3 with your name
		  //and csuLaker3 with your laker id
		  Person3 p3 = new Person3("Kyle Sterling");
		  toPrint += p3.toString("900527469");
                  ...
                  Person5 p5 = new Person5("Jahsi");
                  toPrint += p5.toString("900652494");
